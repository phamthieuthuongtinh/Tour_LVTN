                ...
                <table class="table table-striped table-valign-middle" >
                  ...
                  <tbody>
                    ...
                    <tr class="">
                          ...
                          @else
                            <td>Người lớn: {{$orderdetails->nguoi_lon}} x  {{number_format($orderdetails->tour->price*(100-$orderdetails->sale)/100)}}đ<br>
                                Trẻ em: {{$orderdetails->tre_em}} x {{number_format($orderdetails->tour->price_treem*(100-$orderdetails->sale)/100)}}đ<br>
                                Trẻ nhỏ: {{$orderdetails->tre_nho}} x {{number_format($orderdetails->tour->price_trenho*(100-$orderdetails->sale)/100)}}đ<br>
                                Sơ sinh: {{$orderdetails->so_sinh}} x {{number_format($orderdetails->tour->price_sosinh*(100-$orderdetails->sale)/100)}}đ
                            </td>
                          @endif
                    </tr>
